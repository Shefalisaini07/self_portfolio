    ...
    <section className="contact section">
      ...
      <div className="contact__container container grid">
        <div className="contact__data">
          ...
          <p className="contact__description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe ab nobis nulla autem optio blanditiis id nihil perspiciatis quis beatae, eius animi voluptatem voluptates placeat?</p>
          ...
          <div className="contact__info">
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">shefalisaini2@gmail.com</h4>
              </div>
            </div>
            ...
            <div className="info__item">
              ...
              <div>
                ...
                <h4 className="info__desc">+91-8920777383</h4>
              </div>
            </div>
          </div>
